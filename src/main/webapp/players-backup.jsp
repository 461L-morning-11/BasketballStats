	...
	<main role="main" class="container">
		...
		<div class="main-content">
			...
			try {
				...
				.executeQuery("SELECT * FROM players ORDER BY " + sortBy + " LIMIT " + startInt + ", " + endInt);
			%>
			<div class="container">
				<div class="row">
					<%
					...
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm text-white bg-dark">
							<a class="itemCardLink"
								...
								<div class="card-body">
									<h5 class="card-text">${fn:escapeXml(player_first_name)}
										${fn:escapeXml(player_last_name)}</h5>
		...
		<nav aria-label="Page navigation">
			<ul class="pagination justify-content-center">
				...
				<li class="page-item"><a class="page-link"
					href="players.jsp?sortBy=${sortBy}&page=${page-3}">${page-3}</a></li>
				<%
					}
				%>
				<%
				...
				%>
				<li class="page-item"><a class="page-link"
					href="players.jsp?sortBy=${sortBy}&page=${page-2}">${page-2}</a></li>
				<%
					}
				%>
				<%
				...
				%>
				<li class="page-item"><a class="page-link"
					href="players.jsp?sortBy=${sortBy}&page=${page-1}">${page-1}</a></li>
				<%
					}
				%>
