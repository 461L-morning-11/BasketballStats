	...
	<main role="main" class="container">
		...
		<div class="row">
			<div class="specificTeam">
				<div class="center">
					<h1>
						<b>${fn:escapeXml(player_first_name)}
							${fn:escapeXml(player_last_name)}</b>
						<%
							if (height_feet != null) {
						%><br> -
					...
					<div class="center">
						<p>${fn:escapeXml(player_first_name)}
							is a ${fn:escapeXml(player_position)} for the <a class="teamLink"
								href="specificTeam.jsp?teamId=${fn:escapeXml(player_team_id)}">${fn:escapeXml(player_team_name_long)}</a>
							in the ${fn:escapeXml(player_team_conference)}ern Conference
						</p>
					</div>
				</div>
			</div>
